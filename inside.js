...
window.onload = async () => {
    ...
    var catText =  ["Breakfast in bed","Massage Night", "Love Playlist", "Art Night", "Movie Marathon\
        ...
        ", "Gardening Together","Stargazing Night", "Candle Lit Dinner","Time Capsule","Tech-free Evenıng\
    ...
    var functionFinished = function() {
        ...
        message_popup(catText[wheel._currentIndex],"Inside the House",couponText[0]);
        finishedSpin=true;
        wheel.spinTo(1);
        wheel.isSpinning=0;
