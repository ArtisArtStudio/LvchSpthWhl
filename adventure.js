...
window.onload = async () => {
    ...
    var couponText = ["Scale new heights together at an indoor rock climbing gym","Experience an adrenaline rush with a thrilling zip lining adventure","Connect with nature by going on a scenic hike or nature walk as a couple","Experience the great outdoors together with a camping adventure. If you don’t have equipment, you can rent a cabin or RV/camper","Plan a road trip together along a scenic route discovering new places and strengthening your bond","Thrilling rides, laughter filled moments and shared cotton candy. Spend an adventurous day at an amusement park","Embrace winter sports and go for ice skating, skiing or snowboarding","Take a hot air balloon ride together embracing breathtaking views","Take a guided rafting ride for beginners and paddle together","Splash, laugh and and bond in a thrilling water park adventure"];
    var a = new Image();
