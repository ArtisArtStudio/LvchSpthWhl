...
window.onload = async () => {
    ...
    var couponText = ["Make personalized pizzas with your favorite toppings at home", "Share a cozy fondue night with a variety of dipping options","Compete to create a gourmet meal with surprise ingredients","Cook a romantic dinner together and bond over shared culinary experiences","Choose a baking project, cookies, cupcakes, or a cake, and Have fun decorating your creations with icing, sprinkles, and more","Set up an ice cream bar with an array of toppings for sweet treat","Visit a brunch spot or create your own brunch spread at home","Combine different cheeses and wines for a sophisticated tasting","Try cooking dishes from a specific international cuisine together","Take a road trip to explore iconic regional dishes or restaurants along the way","Explore different food trucks in your area for a diverse culinary experience","Indulge in a variety of desserts at a local bakery or dessert-themed event","Enjoy a fancy tea time with a variety of teas and treats","Experiment with mixing and creating your own cocktails at home","Visit multiple restaurants for small plates, trying a bit of everything","Cook over a campfire and enjoy nature with a culinary twist","Explore vegetarian or vegan recipes for a flavorful meal","Attend a chocolate making workshop or visit a chocolatier for chocolate tasting","Try cooking dishes from a specific international cuisine together","Make savory and sweet crepes filled with your favorite ingredients"];
    var a = new Image();
