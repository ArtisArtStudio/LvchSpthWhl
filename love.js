...
window.onload = async () => {
    ...
    window.addEventListener('click', (e) => {
      ...
      if (e.target === btn) {
        ...
        wheel.spinTo(randomInRangeint(1000,2500),duration,easeOutCubic);
...
var Wheel = class {
    ...
    dragEnd() {
        ...
        this.refreshCursor(), e > 90 && this.spinTo(randomInRangeint(1000,2500),7000,easeOutCubic);// && this.beginSpin(e * (1e3 / 250), "interact")
    }
